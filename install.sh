...
cp "$REPO_DIR/hooks/interface-guard.sh" "$CLAUDE_DIR/hooks/interface-guard.sh"
chmod +x "$CLAUDE_DIR/hooks/interface-guard.sh"
...
echo "  - 11 plugins"
echo "  - 15 hooks (interface guard, security, trace compaction, injection defense)"
